...
st.image('https://image.cnbcfm.com/api/v1/image/106962967-1634709558798-gettyimages-1235570383-porzycki-cryptocu210928_npbUe.jpeg?v=1635185551', width=325)
...
with st.form("my_form"):
        ...
        if submitted:
                st.write("Market Account: ", mkt_account_input, (private_key_input, type="password")," || ", "Account: ", options, " || ", "Fee Agreement: ", fee_agreement)
